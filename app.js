...
viewer.shadowMap.softShadows = false; // Wygładza cienie
viewer.shadowMap.fadingEnabled = true;

viewer.scene.light = new Cesium.SunLight();
viewer.scene.globe.enableLighting = true; // Włącza globalne oświetlenie
...
viewer.scene.atmosphere.dynamicLighting = Cesium.DynamicAtmosphereLightingType.NONE;
		...
		osmBuildingsTileset.shadows = Cesium.ShadowMode.ENABLED; // Aktywacja cieni dla budynków
...
async function initializeChurchModel() {
  try {
	...
	churchModel.shadows = Cesium.ShadowMode.ENABLED; // Aktywacja cieni dla modelu kościoła
